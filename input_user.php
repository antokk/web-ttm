				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<?php 
							...
							$qq = mysqli_query($koneksi,"SELECT max(id_user) as maxKode FROM user");
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" action="" method="post" name="form" role="form">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="id_user" value="<?=$a;?>" readonly="readonly" id="form-field-1" class="col-xs-10 col-sm-5" required />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="username" value="<?=$b;?>" id="form-field-1" placeholder="Username" class="col-xs-10 col-sm-5" required />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="password" value="<?=$c;?>" id="form-field-1" placeholder="Password" class="col-xs-10 col-sm-5" required />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="nama_lengkap" value="<?=$d;?>" id="form-field-1" placeholder="Nama Lengkap" class="col-xs-10 col-sm-5" required />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="nip" value="<?=$e;?>" id="form-field-1" placeholder="NIP" class="col-xs-10 col-sm-5" required />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<select class="chosen-select form-control" name="level" value="<?=$f;?>" id="form-field-select-3" data-placeholder="Choose a State..." required>
																<option value="">  </option>
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											...
											&nbsp; &nbsp; &nbsp;
											<a href="user.php" class="btn btn-green">
