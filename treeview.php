													...
													<ul >
														...
														while($baca_folder = readdir($buka_folder))
														 ...
														 while(list($index, $nama_file) = each($file_array)) {
															 $abc = filetype($nama_file);
															 if($abc == "file"){
																echo "<li><i class='ace-icon fa fa-file red'></i> <a href='$nama_file'>$nama_file</a> (". round(filesize($nama_file)/1024,1) . "kb)</li>";
															 }else{
																 echo "<li><i class='ace-icon fa fa-folder green'></i> <a href='$nama_file'>$nama_file</a> (". round(filesize($nama_file)/1024,1) . "kb)</li>";
															 }
														 }
