													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="btn btn-info btn-xs" href="absensi.php?id=<?php echo $id_absensi;?>">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>

																<a class="btn btn-success btn-xs" onclick="javascript: return confirm('Apakah anda Yakin Ingin Menghapus Data  ?')" href="hapus.php?id=<?php echo $id_absensi;?>&aksi=absensi">
